...
//     console.log('productResp', productResp); // inspect shape
//     const productId = productResp?.data?.Id; // per your AddProduct: data = new { product.Id }
//     if (!productId) {
//       throw new Error("Product saved but no productId was returned. Check API response.");
//     }

//     // 2) Upload images one by one (if any). mark first image as primary
...
import styles from './ProductModal.module.css';
import { addProduct, getCategoryTree, uploadProductImage } from '../api/api';
import axiosInstance from '../api/axiosInstance'; // fallback direct upload if needed
